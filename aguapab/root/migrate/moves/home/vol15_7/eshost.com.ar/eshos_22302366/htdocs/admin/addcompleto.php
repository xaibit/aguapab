...
<body>
	<?php
		...
		$where="Nro=".$nro;	
		$cliente = $db_manager->get_element('Nombre, Direccion, calleZ, Altura','Clientes',$where);
			...
			<div class="row">
				<div class="eight columns">
					...
					<form class="form-signin" action="check_addpedido.php" method="get">
        					...
        					<input type="text" id="direccion" name="direccion" class="form-control" placeholder="" value="<?php echo $cliente['Direccion']; ?>" readonly>
