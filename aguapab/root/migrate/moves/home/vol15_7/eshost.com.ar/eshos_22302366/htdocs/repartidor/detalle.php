			...
			<div class="row">
				<div class="eight columns">
					...
					<form class="form-signin" action="check_entrega.php" method="get">
						...
						<input type="text" id="repar" name="repar" class="form-control" value="<?php echo $_SESSION['id_user']; ?>" style="display:none;">
